        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Border Meal Monthly</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <table id="basic-datatable" class="table dt-responsive table-striped w-100">
                            ...
                            @foreach ($monthly as $key => $meal)
                                <tr>
                                    ...
                                    <td>{{$meal->date}}</td>
                                    <td>
                                        <a href="{{route('admin.dailyMeals',$meal->date)}}" class="btn btn-blue rounded-pill waves-effect waves-light"><i class="fa fa-eye"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
