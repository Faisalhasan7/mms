                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="service" class="form-label">Picture</label>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="service" class="form-label">National ID Card</label>
                                        </div>
                                            <img id="showImg" src="{{$border_detail->nid_pic ?"/". $border_detail->nid_pic : asset('/backend/assets/no_image.jpg')}}" class="rounded-circle img-thumbnail avatar-lg" alt="profile-image">
                                    </div>
