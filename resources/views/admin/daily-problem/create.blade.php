        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Daily Problem</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form action="{{route('admin.daily_problem_store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('problem_name') is-invalid @enderror" name="problem_name" id="problem_name" value="{{old('problem_name')}}">
                                            @error('problem_name')
                                            <span class="text-danger fw-bold">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="solution" id="solution" class="form-control @error('solution') is-invalid @enderror"cols="30" rows="10">{{old('solution')}}</textarea>
                                            @error('solution')
                                            <span class="text-danger fw-bold">{{$message}}</span>
                                            @enderror
                                        </div>
